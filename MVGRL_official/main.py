...
if __name__ == '__main__':
    ...
    # Step 1: Prepare data =================================================================== #
    graph, diff_graph, feat, label, train_mask, val_mask, test_mask, edge_weight = process_dataset(args.dataname, args.epsilon)
    ...
    for epoch in range(args.epochs):
        ...
        if loss < best:
            best = loss
            cnt_wait = 0
            th.save(model.state_dict(), './output/model_state.pt')
        else:
            cnt_wait += 1
    ...
    model.load_state_dict(th.load('./output/model_state.pt'))
